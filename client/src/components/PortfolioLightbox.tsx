            ...
            <div className="p-8 lg:p-12 space-y-6">
              ...
              <div className="pt-6 border-t space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>• إعداد المخططات الهندسية لأنظمة الإنذار والإطفاء وفق الكود السعودي </p>
                  <p>• الإشراف الميداني على تنفيذ أعمال السلامة والتأكد من مطابقتها للمعايير </p>
                  <p>• تسليم الموقع للدفاع المدني بعد استكمال جميع أعمال السلامة </p>
                  <p>• الحصول على شهادة الاستلام من المكتب الهندسي المعتمد</p>
                </div>
              </div>
            </div>
          </div>
