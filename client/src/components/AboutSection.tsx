        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 text-lg leading-loose text-muted-foreground">
              <p>
                شركة الهندسة المتقدمة هي إحدى الشركات الرائدة في مجال الاستشارات الهندسية في المنطقة. نتميز بخبرة تمتد لأكثر من 15 عامًا في تصميم وتنفيذ المشاريع الهندسية الكبرى.
              </p>
              <p>
